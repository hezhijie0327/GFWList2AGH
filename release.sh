...
function AnalyseData() {
    cnacc_data=($(domain_regex="^(([a-z]{1})|([a-z]{1}[a-z]{1})|([a-z]{1}[0-9]{1})|([0-9]{1}[a-z]{1})|([a-z0-9][-\.a-z0-9]{1,61}[a-z0-9]))\.([a-z]{2,13}|[a-z0-9-]{2,30}\.[a-z]{2,3})$" && lite_domain_regex="^([a-z]{2,13}|[a-z0-9-]{2,30}\.[a-z]{2,3})$" && cat "./gfwlist2agh_custom_cnacc.tmp" | grep -v "\#" | grep "\@" | tr -d "\@" > "./cnacc_addition.tmp" && cat "./gfwlist2agh_custom_cnacc.tmp" | grep -v "\#" | grep "\!" | tr -d "\!" > "./cnacc_subtraction.tmp" && cat "./gfwlist2agh_custom_gfwlist.tmp" | grep -v "\#" | grep "\@" | tr -d "\@" > "./gfwlist_addition.tmp" && cat "./gfwlist2agh_custom_gfwlist.tmp" | grep -v "\#" | grep "\!" | tr -d "\!" > "./gfwlist_subtraction.tmp" && cat "./cnacc_trusted.tmp" | sed "s/\/114\.114\.114\.114//g;s/server\=\///g" | tr "A-Z" "a-z" | grep -E "${domain_regex}" >> "./cnacc_addition.tmp" && cat "./cnacc_addition.tmp" | grep -E "${lite_domain_regex}" >> "./lite_cnacc_addition.tmp" && cat "./cnacc_domain.tmp" "./gfwlist2agh_custom_cnacc.tmp" | tr "A-Z" "a-z" | grep -E "${domain_regex}" | sort | uniq > "./cnacc_checklist.tmp" && cat "./gfwlist_base64.tmp" "./gfwlist_domain.tmp" "./gfwlist2agh_custom_gfwlist.tmp" | sed "s/http\:\/\///g;s/https\:\/\///g" | tr -d "|" | tr "A-Z" "a-z" | grep -E "${domain_regex}" | sort | uniq > "./gfwlist_checklist.tmp" && cat "./cnacc_checklist.tmp" | rev | cut -d "." -f 1,2 | rev | sort | uniq > "./lite_cnacc_checklist.tmp" && cat "./gfwlist_checklist.tmp" | rev | cut -d "." -f 1,2 | rev | sort | uniq > "./lite_gfwlist_checklist.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./dead_domain.tmp" "./cnacc_checklist.tmp" > "./cnacc_alive.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./dead_domain.tmp" "./gfwlist_checklist.tmp" > "./gfwlist_alive.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./dead_domain.tmp" "./lite_cnacc_checklist.tmp" > "./lite_cnacc_alive.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./dead_domain.tmp" "./lite_gfwlist_checklist.tmp" > "./lite_gfwlist_alive.tmp" && cat "./cnacc_alive.tmp" "./cnacc_addition.tmp" "./lite_cnacc_alive.tmp" "./lite_cnacc_addition.tmp" | sort | uniq > "./cnacc_added.tmp" && cat "./gfwlist_alive.tmp" "./gfwlist_addition.tmp" "./lite_gfwlist_alive.tmp" "./lite_gfwlist_addition.tmp" | sort | uniq > "./gfwlist_added.tmp" && cat "./lite_cnacc_alive.tmp" "./lite_cnacc_addition.tmp" | sort | uniq > "./lite_cnacc_added.tmp" && cat "./lite_gfwlist_alive.tmp" "./lite_gfwlist_addition.tmp" | sort | uniq > "./lite_gfwlist_added.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./cnacc_subtraction.tmp" "./cnacc_added.tmp" > "./cnacc_data.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./gfwlist_subtraction.tmp" "./gfwlist_added.tmp" > "./gfwlist_subtracted.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./cnacc_subtraction.tmp" "./lite_cnacc_added.tmp" > "./lite_cnacc_data.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./gfwlist_subtraction.tmp" "./lite_gfwlist_added.tmp" > "./lite_gfwlist_subtracted.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./cnacc_data.tmp" "./gfwlist_subtracted.tmp" > "./gfwlist_data.tmp" && awk 'NR == FNR { tmp[$0] = 1 } NR > FNR { if ( tmp[$0] != 1 ) print }' "./lite_cnacc_data.tmp" "./lite_gfwlist_subtracted.tmp" > "./lite_gfwlist_data.tmp" && cat "./cnacc_data.tmp" "./lite_cnacc_data.tmp" | sort | uniq | awk "{ print $2 }"))
